...
public class AllMembers extends javax.swing.JFrame {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        try{
            conn = Javaconnect.ConnecrDB();
            String sql = "SELECT `mid` AS MemberID, `fullname` AS FullName, `initialname` AS NameWithInitial, `dob` AS DOB, `age` AS Age, `nic` AS NIC, `phoneno` AS PhoneNo, `job` AS Proffesion, `address` AS Address FROM `member` WHERE fullname LIKE  '%"+txtSearch.getText()+"%' OR mid = '"+txtSearch.getText()+"'";
    ...
    private void tableLoard(){
        ...
        try{
            conn = Javaconnect.ConnecrDB();
            String sql = "SELECT `mid` AS MemberID, `fullname` AS FullName, `initialname` AS NameWithInitial, `dob` AS DOB, `age` AS Age, `nic` AS NIC, `phoneno` AS PhoneNo, `job` AS Proffesion, `address` AS Address FROM `member`";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            AllMembers.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
